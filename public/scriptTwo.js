var auth2 = {};
  ...
  function signInPressed() {
    ...
    if( document.location.href.indexOf("terminal.html") <= -1 ) {
      console.log("switching..." + document.location.href );
 ...
 */
 var initSigninV2 = function() {
  ...
  console.log( auth2 )
  // if( Object.keys(auth2).length === 0 && JSON.stringify(auth2) === JSON.stringify({}) ) {
    // console.log("init");
      // auth2 = gapi.auth2.init({
      // client_id: 'CLIENT_ID.apps.googleusercontent.com',
    // scope: 'profile'
